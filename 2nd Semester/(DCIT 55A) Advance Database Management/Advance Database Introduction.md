#inProgress 
## [[Structured Query Language#History|Origin]]
...
- **Self-describing nature of a database system**
	...
	- defines and describe the extent, type, structure, and format of all data and relationship between data, representing the data about the data and what can be applied to it.
...
- **Separation of Data and Applications**
	- Application software does not need any knowledge about the physical data storage like encoding, format, storage place, etc. It only communicates with the management system of a database (DBMS) via a standardized language like SQL. 
	- This insulation between the programs and data is also called program-data independence (Watt, 2014a).
...
- **Security**
	- provides security mechanism to control access to data, protecting it from unauthorized access and ensuring confidentiality.

- **Efficiency**
	- Store and retrieve large amounts of data, making it possible to quickly access and manipulate data as needed.

- **Recovery**
	- More or less same as **Data Persistence**
	- Provides mechanisms to backup and recovery in case of system failure, data corruption and other issues

- **Flexibility**
	- Can adapt to  changing business requirements or user needs. 
	- Enabling modifications to the database structure and content as necessary

- **Scalability**
	- Handle large volumes of data and can scale up and down as needed to accommodate changes.
